...
Uwierzytelnianie dwuskładnikowe (2FA) jest obowiązkowe dla każdego konta Persate. Mechanizm ten zapewnia ochronę konta nawet w przypadku ujawnienia hasła, każde logowanie wymaga dodatkowo aktualnego kodu tymczasowego generowanego przez sparowaną aplikację autoryzacyjną.
...
## Procedura konfiguracji uwierzytelniania dwuskładnikowego
...
Przy każdym kolejnym logowaniu, aplikacja Persate wymaga podania sześciocyfrowego kodu z aplikacji autoryzacyjnej.
...
Odrzucenie kodu najczęściej wskazuje, że wartość wygasła pomiędzy momentem wygenerowania a wprowadzenia. W większości przypadków odczekanie i wprowadzenie nowo wygenerowanego kodu rozwiązuje problem.
