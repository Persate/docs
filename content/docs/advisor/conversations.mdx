...
* **File-add button** — the icon on the left side opens the document selector covering the Repository and the public corpus (the same one triggered by the `@` symbol).
