...
* **The advisor gracefully closes its work at turn limits.** A broad query ending at the limit returns a full response for the covered portion and a single-line note regarding the deferred scope.
